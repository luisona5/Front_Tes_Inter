// src/pages/Administrador/pdf/DirectoresTablePDF.jsx
        ...
        <Document>
            ...
            <Page size="A4" orientation="portrait" style={styles.page}>
                ...
                <View style={styles.header}>
                    <Text style={styles.title}>Lista de Directores de Eventos</Text>
                ...
                <View style={styles.table}>
                    ...
                    {directores.map((director, index) => (
                        <View style={styles.tableRow} key={director._id}>
                            ...
                            <Text style={[styles.tableCell, styles.col2]}>{director.apellidoDirector}</Text>
                            <Text style={[styles.tableCell, styles.col3]}>{director.nombreDirector}</Text>
                            <Text style={[styles.tableCell, styles.col4]}>{director.cedulaDirector}</Text>
                            <Text style={[styles.tableCell, styles.col5]}>{director.emailDirector}</Text>
                            <Text style={[styles.tableCell, styles.col6]}>{director.telefonoDirector}</Text>
                            <View style={[styles.tableCell, styles.col7]}>
                                <Text style={director.estadoDirector ? styles.statusActive : styles.statusInactive}>
