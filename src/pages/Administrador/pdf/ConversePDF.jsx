      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header} fixed>
          ...
          <View style={styles.headerTextContainer}>
            ...
            <Text style={styles.subtitle}>Informe Detallado del Director</Text>
          </View>
        ...
        <View style={styles.sectionBox}>
          <View style={styles.row}>
            ...
            <Text style={styles.value}>{data.cedulaDirector || "N/A"}</Text>
          </View>
          
          <View style={styles.row}>
            <Text style={styles.label}>Nombre:</Text>
            <Text style={styles.value}>{data.nombreDirector || "N/A"}</Text>
          </View>
          
          <View style={styles.row}>
            <Text style={styles.label}>Apellido:</Text>
            <Text style={styles.value}>{data.apellidoDirector || "N/A"}</Text>
          </View>
          
          <View style={styles.row}>
            <Text style={styles.label}>Email:</Text>
            <Text style={styles.value}>{data.emailDirector || "N/A"}</Text>
          </View>
          
          <View style={styles.row}>
            <Text style={styles.label}>Teléfono:</Text>
            <Text style={styles.value}>{data.telefonoDirector || "N/A"}</Text>
          </View>
        </View>
