...
const PanelAdministrador = () => {
    ...
    useEffect(() => { 
        console.log('🚀 Iniciando Panel Administrador...');
        fetchDeportes();
        fetchEstadisticas();
    }, []);
    ...
    // Función para recargar deportes
    const handleRecargarDeportes = () => {
        fetchDeportes();
    };
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
                                ...
                                <div className="text-sm space-y-1">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-bold text-gray-900">
                                            {estadisticas.directores?.porcentajeActivos || calcularPorcentaje(estadisticas.directores?.activos || 0, estadisticas.directores?.total || 0)}%
                                        </span>
                                    </div>
                                    <div className="flex justify-between">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
                                <div className="flex items-center justify-between mb-4">
                                    <div>
                                        <p className="text-sm font-medium text-gray-500">RESUMEN GENERAL</p>
                                        <p className="text-3xl font-bold text-gray-900 mt-1">
                                            {formatNumber(
                                                (estadisticas.estudiantes?.total || 0) + 
                                                (estadisticas.directores?.total || 0)
                                            )}
                                        </p>
                                    </div>
                                ...
                                <div className="text-sm space-y-1">
                                    ...
                                    <div className="flex justify-between">
                                        <span className="text-gray-700">Deportes Activos:</span>
                                        <span className="font-bold">{formatNumber(estadisticas.deportes?.activos || 0)}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-gray-700">Categorías Activas:</span>
                                        <span className="font-bold">{formatNumber(estadisticas.categorias?.activas || 0)}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-gray-700">Inscripciones Activas:</span>
                                        <span className="font-bold">{formatNumber(estadisticas.inscripciones?.aprobadas || 0)}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
