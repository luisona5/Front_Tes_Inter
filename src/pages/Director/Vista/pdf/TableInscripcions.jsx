...
const styles = StyleSheet.create({
  ...
  col1: { width: "5%" },    // N°
  col2: { width: "12%" },   // Cédula
  col3: { width: "13%" },   // Nombre
  col4: { width: "13%" },   // Apellido
  col5: { width: "13%" },   // Deporte
  col6: { width: "13%" },   // Categoría
  col7: { width: "21%" },   // Email
  col8: { width: "10%" },   // Estado
...
const TableInscripcionPDF = ({ inscriptions }) => {
      ...
      <Page size="A4" orientation="landscape" style={styles.page}>
        ...
        <View style={styles.table}>
          ...
          <View style={[styles.tableRow, styles.tableHeader]}>
            ...
            <Text style={[styles.tableCell, styles.col4]}>Apellido</Text>
            <Text style={[styles.tableCell, styles.col5]}>Deporte</Text>
            <Text style={[styles.tableCell, styles.col6]}>Categoría</Text>
            <Text style={[styles.tableCell, styles.col7]}>Email</Text>
            <Text style={[styles.tableCell, styles.col8]}>Estado</Text>
          </View>

          {/* Filas de datos */}
          {inscriptions.map((inscripcion, index) => (
        ...
        <View style={styles.totalDirectores}>
          <Text style={styles.totalText}>
            Total de Inscripciones: {inscriptions.length}
          </Text>
        </View>
