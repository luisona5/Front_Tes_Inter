...
export const Forgot = () => {
    ...
    const sendMail = async (dataForm) => {
        const endpoints = {
            admin: '/administrador/recuperarpassword',
            director: '/recuperarpasswordDirector',
            estudiante: '/recuperarpasswordEstudiante'
        };
        
        const url = `${import.meta.env.VITE_BACKEND_URL}${endpoints[rol]}`;
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            className="block w-full rounded-xl border border-slate-300 py-3 pl-10 pr-4 text-slate-700 focus:ring-orange-500/20 focus:outline-none transition-all duration-200 bg-white hover:border-slate-400"
                                        >
