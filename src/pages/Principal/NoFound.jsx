    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen bg-white px-4 overflow-hidden">
            <div className="relative z-10 flex flex-col items-center justify-center gap-8 max-w-2xl w-full text-center">
                ...
                {/* Imagen - Verifica que la ruta sea correcta en tu carpeta public */}
                <div className="w-full max-w-md">
                    <img 
                        src="/images/deporte1.png" 
                        alt="Página no encontrada" 
                        className="w-full h-auto object-cover rounded-2xl shadow-xl"
                        onError={(e) => { e.target.src = 'https://via.placeholder.com/400x300?text=404+Error'; }} // Fallback por si no encuentra la imagen
                    />
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-lg text-slate-600 max-w-md">
                        El recurso que buscas no se encuentra disponible o ha sido movido.
                    </p>
                </div>
